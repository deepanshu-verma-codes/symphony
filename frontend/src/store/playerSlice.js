...
export const playerSlice = createSlice({
  ...
  reducers: {
    ...
    playNext: (state) => {
      ...
      if (state.isRepeat) {
        state.isPlaying = true; // Handled in player
        return;
      }
      if (state.isShuffle) {
...
export const { setCurrentSong, togglePlay, setVolume, setQueue, toggleShuffle, toggleRepeat, playNext, playPrevious } = playerSlice.actions;
